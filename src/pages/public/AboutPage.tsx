  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="text-center max-w-3xl mx-auto mb-12">
        <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-indigo-500/10 border border-indigo-500/30 text-xs font-bold text-cyan-400 mb-4 shadow-md">
      ...
      {/* Our Mission Card */}
      <div className="bg-slate-900/80 backdrop-blur-md p-8 sm:p-10 rounded-3xl border border-indigo-500/20 shadow-2xl shadow-indigo-950/50 mb-12">
        <div className="flex items-center gap-3 mb-4">
          <div className="p-3 rounded-2xl bg-gradient-to-r from-cyan-500 to-indigo-600 text-white shadow-md">
            <Bot className="w-6 h-6" />
          </div>
          <div>
            <h2 className="text-xl font-black text-white">Our Mission</h2>
            <span className="text-xs font-bold text-cyan-400">Transforming Enterprise Intelligence</span>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        {/* Smart Routing */}
        <div className="bg-slate-900/80 backdrop-blur-md text-white p-8 rounded-3xl border border-indigo-500/20 shadow-xl flex flex-col justify-between group hover:border-indigo-400/40 transition-all">
          <div>
            <div className="w-12 h-12 rounded-2xl bg-indigo-500/20 text-cyan-300 border border-indigo-500/30 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
        ...
        {/* Always-On Support */}
        <div className="bg-slate-900/80 backdrop-blur-md text-white p-8 rounded-3xl border border-indigo-500/20 shadow-xl flex flex-col justify-between group hover:border-purple-400/40 transition-all">
          <div>
            <div className="w-12 h-12 rounded-2xl bg-purple-500/20 text-purple-300 border border-purple-500/30 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
        ...
        {/* Privacy & Ethics */}
        <div className="bg-slate-900/80 backdrop-blur-md text-white p-8 rounded-3xl border border-indigo-500/20 shadow-xl flex flex-col justify-between group hover:border-cyan-400/40 transition-all">
          <div>
